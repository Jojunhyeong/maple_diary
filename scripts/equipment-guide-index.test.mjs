...
test('nearby searches share a narrow 100k cache bucket', () => {
  ...
  assert.equal(equipmentGuideCacheKey('히어로', 111_040_000), 'v15:히어로:111000000');
  assert.equal(equipmentGuideCacheKey('히어로', 111_040_000, '2026-09-18'), 'v15:히어로:111000000:2026-09-18');
});
