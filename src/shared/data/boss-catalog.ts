...
export const BOSS_CATALOG: BossCatalogGroup[] = [
  {
    ...
    bosses: [
      ...
      },
      {
        ...
        category: 'grandis',
        maxPartySize: 6,
        difficulties: { easy: 311000000, normal: 561000000, hard: 1340000000, extreme: 4320000000 },
        dropItems: [{ id: 'estella_earring', name: '에스텔라 이어링' }],
      },
      { id: 'originator', name: '최초의 대적자', category: 'grandis', maxPartySize: 3, difficulties: { easy: 324000000, normal: 589000000, hard: 1510000000, extreme: 4960000000 } },
      {
        ...
        category: 'grandis',
        maxPartySize: 6,
        difficulties: { easy: 419000000, normal: 714000000, hard: 1830000000, extreme: 5670000000 },
        dropItems: [{ id: 'estella_earring', name: '에스텔라 이어링' }],
      },
      {
        id: 'radiant_horn',
  ...
  },
  {
    ...
    bosses: [
      ...
      { id: 'damien', name: '데미안', category: 'subboss', maxPartySize: 6, difficulties: { normal: 18400000, hard: 51500000 } },
      {
        ...
        category: 'subboss',
        maxPartySize: 6,
        difficulties: { normal: 26800000, hard: 79100000 },
      ...
      },
      {
        ...
        category: 'subboss',
        maxPartySize: 6,
        difficulties: { normal: 46300000, hard: 73500000 },
        dropItems: [{ id: 'twilight_mark', name: '트와일라이트 마크' }],
      },
  ...
  },
  {
    ...
    bosses: [
      ...
      { id: 'hilla', name: '힐라', category: 'general', maxPartySize: 6, difficulties: { normal: 455000, hard: 5750000 } },
      {
        ...
        category: 'general',
        maxPartySize: 6,
        difficulties: { easy: 390000, normal: 1520000, hard: 13800000 },
      ...
      { id: 'horntail', name: '혼테일', category: 'general', maxPartySize: 6, difficulties: { easy: 502000, normal: 576000, hard: 770000 } },
      {
        ...
        dropItems: [{ id: 'mechanical_heart', name: '매커니컬 하트' }],
      },
      {
        id: 'pinkbean',
        name: '핑크빈',
        category: 'general',
        maxPartySize: 6,
        difficulties: { normal: 799000, hard: 6580000 },
