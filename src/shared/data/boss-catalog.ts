...
export const BOSS_CATALOG: BossCatalogGroup[] = [
  {
    ...
    bosses: [
      ...
      },
      {
        ...
        category: 'grandis',
        maxPartySize: 6,
        difficulties: { easy: 238000000, normal: 479000000, hard: 1230000000, extreme: 4140000000 },
        dropItems: [{ id: 'estella_earring', name: '에스텔라 이어링' }],
      },
      { id: 'originator', name: '최초의 대적자', category: 'grandis', maxPartySize: 3, difficulties: { easy: 261000000, normal: 532000000, hard: 1390000000, extreme: 4712000000 } },
      {
        id: 'kaling',
        name: '카링',
        category: 'grandis',
        maxPartySize: 6,
        difficulties: { easy: 320000000, normal: 593000000, hard: 1560000000, extreme: 5387000000 },
        dropItems: [{ id: 'estella_earring', name: '에스텔라 이어링' }],
      },
      {
        id: 'bellona',
      ...
      },
      {
        ...
        category: 'grandis',
        maxPartySize: 3,
        difficulties: { normal: 576000000, hard: 2678000000 },
  ...
  },
  {
    ...
    bosses: [
      ...
      { id: 'suu', name: '스우', category: 'subboss', maxPartySize: 6, difficultyMaxPartySize: { extreme: 2 }, difficulties: { normal: 8350000, hard: 48900000, extreme: 545000000 } },
      { id: 'damien', name: '데미안', category: 'subboss', maxPartySize: 6, difficulties: { normal: 8750000, hard: 46400000 } },
      {
        id: 'slime',
        name: '가엔슬',
        category: 'subboss',
        maxPartySize: 6,
        difficulties: { normal: 12700000, hard: 71300000 },
      ...
      },
      {
        ...
        category: 'subboss',
        maxPartySize: 6,
        difficulties: { normal: 22000000, hard: 66300000 },
        dropItems: [{ id: 'twilight_mark', name: '트와일라이트 마크' }],
      },
      { id: 'jinhilla', name: '진 힐라', category: 'subboss', maxPartySize: 6, difficulties: { normal: 67600000, hard: 100000000 } },
      {
        id: 'darknell',
        name: '듄켈',
        category: 'subboss',
  ...
  },
  {
    ...
    bosses: [
      { id: 'zakum', name: '자쿰', category: 'general', maxPartySize: 6, difficulties: { hard: 4040000 } },
      { id: 'magnus', name: '매그너스', category: 'general', maxPartySize: 6, difficulties: {  hard: 4280000 } },
      { id: 'hilla', name: '힐라', category: 'general', maxPartySize: 6, difficulties: {  hard: 1280000 } },
      {
        ...
        category: 'general',
        maxPartySize: 6,
        difficulties: {  hard: 6550000 },
        dropItems: [{ id: 'papulatus_mark', name: '파풀라투스 마크' }],
      },
      { id: 'pierre', name: '피에르', category: 'general', maxPartySize: 6, difficulties: { hard: 4080000 } },
      { id: 'vonbon', name: '반반', category: 'general', maxPartySize: 6, difficulties: {hard: 4070000 } },
      { id: 'crimsonqueen', name: '블러디퀸', category: 'general', maxPartySize: 6, difficulties: { hard: 4070000 } },
      { id: 'vellum', name: '벨룸', category: 'general', maxPartySize: 6, difficulties: {  hard: 4640000 } },
