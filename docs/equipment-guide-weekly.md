...
- 유효 표본 최소 100명, 이전 유효 표본의 50% 이상, 기존 직업·근접 전투력 표본의 50% 이상을 확보해야 교체합니다. 이는 급격한 수집 누락을 탐지하는 운영 기준이며 통계적 신뢰도를 보장하지 않습니다. 검증 실패 시 상한과 수집 범위를 점검하세요.
...
5. 실행 요약의 기준일·유효 표본·근접 전투력 표본 수와 Vercel Production 배포 결과를 확인합니다.
